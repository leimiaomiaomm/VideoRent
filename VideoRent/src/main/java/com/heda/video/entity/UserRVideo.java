...
public class UserRVideo {
    private Integer userRVideoId;
    ...
    public Integer getUserRVideoId() {
        return userRVideoId;
    }

    public void setUserRVideoId(Integer userRVideoId) {
        this.userRVideoId = userRVideoId;
    }
